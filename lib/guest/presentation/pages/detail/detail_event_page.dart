                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: DetailEventBanner(
                              ...
                              ticketTypes:
                                  controller.event?.tickets.length ?? 0,
                            ),
                          ),
                          const Positioned(
                            left: 24,
                          ...
                          children: [
                            PrimaryTabBar(
                              ...
                              onTabChanged: (index) {
                                ...
                                delegate.toNamed(
                                  "${AppRoutes.guest}/${AppRoutes.events}/${Get.parameters['id']}${controller.fragments[index]['route']}",
                                );
                              },
                            ),
                            ...
                            Expanded(
                              child: GetRouterOutlet(
                                anchorRoute:
                                    "${AppRoutes.guest}/${AppRoutes.events}/${Get.parameters['id']}",
                                initialRoute:
                                    "${AppRoutes.guest}/${AppRoutes.events}/${Get.parameters['id']}${AppRoutes.info}",
                                delegate: delegate,
                              ),
                            ),
                          ],
